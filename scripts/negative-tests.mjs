...
const source={source_type:'HTTPS_URL',url:'https://example.com/a'};
const base={request_id:'t',event_id:'e',width:1280,height:720,fps:30,audio:{source,expected_duration_seconds:3},visual_items:[{visual_item_id:'v1',visual_beat_id:'b1',kind:'VIDEO',source,start_frame:0,duration_frames:45,fit:'COVER'},{visual_item_id:'v2',visual_beat_id:'b2',kind:'VIDEO',source,start_frame:45,duration_frames:45,fit:'COVER'}]};
const media={audio:{duration_seconds:3},visual_items:{v1:{duration_seconds:2},v2:{duration_seconds:2}}};
