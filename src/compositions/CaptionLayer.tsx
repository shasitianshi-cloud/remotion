...
export const captionLayerSchema = z.object({
  baseVideoUrl: z.string().url().optional(), backgroundColor: z.string(),
...
export const CaptionLayer: React.FC<CaptionLayerProps> = (p) => {
  ...
  return <AbsoluteFill style={{backgroundColor:p.backgroundColor}}>
    {p.baseVideoUrl ? <OffthreadVideo src={p.baseVideoUrl} style={{width:'100%',height:'100%',objectFit:'cover'}}/> : null}
