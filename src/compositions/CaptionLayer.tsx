...
export const CaptionLayer: React.FC<CaptionLayerProps> = (p) => {
  ...
  return <AbsoluteFill style={{backgroundColor:p.backgroundColor}}>
    {p.baseVideoUrl ? <OffthreadVideo src={p.baseVideoUrl} muted={p.sourceVideoMuted ?? false} volume={p.sourceVideoMuted ? 0 : 1} style={{width:'100%',height:'100%',objectFit:'cover'}}/> : null}
